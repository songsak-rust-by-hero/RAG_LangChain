...
# Web scraping config (การตั้งค่าสำหรับการดึงข้อมูลจากเว็บ)
WEB_PATH = "https://docs.langchain.com/oss/python/deepagents/overview" # URL ของหน้าเว็บเป้าหมายที่จะดึงข้อมูล
...
EMBEDDING_MODEL = "sentence-transformers/all-MiniLM-L6-v2" # ชื่อโมเดลที่จะใช้ในการสร้างเวกเตอร์ (embedding) ของข้อความ
